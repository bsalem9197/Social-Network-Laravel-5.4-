                     ...
                     @if ( session()->has('msg') )
                        ...
                        <div class="row" style="border-bottom:1px solid #ccc; margin-bottom:15px">
                            ...
                            <div class="col-md-3 pull-right"> 
                                     ...
                                     <p>
                                        <a href="{{url('/accept')}}/{{$uList->name}}/{{$uList->id}}"  class="btn btn-info btn-sm">Accepter </a>
                                          <a href="{{url('/requestRemove')}}/{{$uList->id}}"  class="btn btn-default btn-sm">Supprimer</a>
