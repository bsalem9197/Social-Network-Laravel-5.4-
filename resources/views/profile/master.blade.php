            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <li> <a href="{{url('/profile')}}/{{Auth::user()->slug}}">Profile </a></li>
                     ...
                     <li><a href="{{url('/findFriends')}}">Trouver Des amis</a></li>
                              <li><a href="{{url('/requests')}}">Demandes reçues
                              ({{App\friendships::where('status',Null)->where('user_requested',Auth::user()->id)->count()}} )</a></li>
                    <li> <a href="{{url('/friends')}}" >Liste d'Amis </a></li>
